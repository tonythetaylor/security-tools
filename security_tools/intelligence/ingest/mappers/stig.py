...
def map_stig_section(section: ExtractedSection) -> KnowledgeDocument:
    return KnowledgeDocument(
        id="stig-baseline",
        title=section.title,
        category=section.category or "stig_guidance",
        applies_to=["hardening", "baseline_configuration", "secure_configuration"],
        tags=sorted(set(section.tags + ["stig"])),
