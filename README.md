...
```
cd existing_repo
git remote add origin http://gitlab.local/root/security-tools.git
git branch -M main
...
* [Set up project integrations](http://gitlab.local/root/security-tools/-/settings/integrations)
